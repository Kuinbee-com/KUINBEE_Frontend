  ...
  return (
    <div className="w-full max-w-5xl mx-auto px-4 py-6 relative">
        ...
        <div className="p-6">
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
              <div className="w-20 h-20 rounded-full flex items-center justify-center bg-gradient-to-r from-[#1a2240] via-[#50587c] to-[#1a2240] shadow-xl transition-transform duration-200 hover:scale-110 hover:shadow-2xl focus:outline-none text-white text-3xl font-bold ring-4 ring-white/40">
                {/* Display user initials */}
                {userInfo.name.split(" ").map((n) => n[0]).join("")}
              </div>
              <div>
                <h2 className="text-2xl font-bold text-[#1a2240] mb-1">{userInfo.name}</h2>
                <p className="text-base text-gray-600 mb-0.5">{userInfo.email}</p>
            ...
            <div className="grid grid-cols-3 gap-3 w-full lg:w-auto">
              <div className="text-center">
                <div className="w-10 h-10 rounded-full bg-gradient-to-r from-[#1a2240]/20 to-[#1a2240]/30 flex items-center justify-center mx-auto mb-1">
                  <DollarSign className="w-5 h-5 text-[#1a2240]" />
                </div>
                <div className="text-lg font-bold text-[#1a2240]">${userInfo.totalSpent}</div>
                <div className="text-xs text-gray-600">Total Spent</div>
              </div>
              <div className="text-center">
                <div className="w-10 h-10 rounded-full bg-gradient-to-r from-[#1a2240]/20 to-[#1a2240]/30 flex items-center justify-center mx-auto mb-1">
                  <Package className="w-5 h-5 text-[#1a2240]" />
                </div>
                <div className="text-lg font-bold text-[#1a2240]">{userInfo.totalPurchases}</div>
                <div className="text-xs text-gray-600">Purchases</div>
              </div>
              <div className="text-center">
                <div className="w-10 h-10 rounded-full bg-gradient-to-r from-[#1a2240]/20 to-[#1a2240]/30 flex items-center justify-center mx-auto mb-1">
                  <Download className="w-5 h-5 text-[#1a2240]" />
                </div>
                <div className="text-lg font-bold text-[#1a2240]">{userInfo.totalDownloads}</div>
      ...
      <div className="w-full isolate">
        ...
        <div className="relative bg-gradient-to-r from-[#f8fafc]/80 via-[#f1f5f9]/90 to-[#e2e8f0]/80 backdrop-blur-xl rounded-2xl shadow-lg border border-white/40 p-2 mb-5">
          <div className="relative flex">
            {/* Moving Spotlight Background */}
            <motion.div
              className="absolute top-0 bottom-0 bg-gradient-to-r from-[#24305e] via-[#4e5a7e] to-[#24305e] rounded-xl shadow-xl py-5"
              animate={{
            ...
            {tabs.map((tab) => (
              <button
                ...
                className={`relative flex-1 rounded-xl font-semibold text-sm py-3 flex items-center justify-center transition-all duration-300 ease-in-out z-10 mx-3.5 ${
                  activeTab === tab.value
        ...
        <AnimatePresence mode="wait">
          ...
          {activeTab === "account" && (
            <div className="relative">
              ...
              >
                <div className="px-6 py-4 border-b border-gray-100/60 bg-gradient-to-r from-[#050a24]/5 to-[#1a2240]/5 flex items-center justify-between">
                  <h3 className="text-xl font-bold bg-gradient-to-r from-[#050a24] to-[#1a2240] bg-clip-text text-transparent">
                    Account Settings
                  </h3>
                  <Button
                    onClick={() => isEditing ? handleSave() : setIsEditing(true)}
                    className="bg-gradient-to-r from-[#24305e] via-[#4e5a7e] to-[#24305e] text-white px-4 py-2 rounded-lg font-semibold transition-all duration-300 text-sm"
                  >
                ...
                <div className="p-6 space-y-6">
                    ...
                    <div className="space-y-5">
                      <div className="space-y-2">
                        ...
                        {isEditing ? (
                          ...
                          <div className="text-base text-[#1a2240] font-medium py-3 px-3 bg-gray-50/50 rounded-lg border border-gray-100">
                            {userInfo.name}
                          </div>
                        )}
                      </div>
                  ...
                  {isEditing && (
                    <div className="flex gap-3 pt-3">
                      <Button
                        onClick={handleSave}
                        className="bg-gradient-to-r from-[#24305e] via-[#4e5a7e] to-[#24305e] text-white px-6 py-2 rounded-lg font-semibold transition-all duration-300 text-sm"
                      >
              ...
              <Table>
                <TableHeader>
                  <TableRow className="bg-gradient-to-r from-slate-100/80 to-blue-50/80 border-b border-gray-200/60 hover:from-slate-200/90 hover:to-blue-100/90 transition-all duration-300">
                    <TableHead className="h-12 px-4 text-left align-middle text-[#1a2240] font-semibold text-sm">
                      Dataset
                    </TableHead>
                    <TableHead className="text-[#1a2240] font-semibold text-sm">
                      Category
                    </TableHead>
                    <TableHead className="text-[#1a2240] font-semibold text-sm">
                      Price
                    ...
                    <TableHead className="text-center text-[#1a2240] font-semibold text-sm">
                      Action
                    </TableHead>
                  </TableRow>
                </TableHeader>
                    ...
                    >
                      <TableCell>
                        <div className="space-y-1">
                          <h4 className="font-semibold text-[#1a2240] text-sm">{purchase.title}</h4>
                          <Badge
                            variant="outline"
                            className={`text-xs ${
                      ...
                      <TableCell>
                        <Badge
                          variant="outline"
                          className="bg-white/80 text-[#1a2240] border border-gray-200 text-xs px-2 py-1 shadow-sm"
                        >
                          {purchase.category}
                        </Badge>
                      </TableCell>
                      <TableCell>
                        <span className="font-bold text-sm text-[#1a2240]">
                          ${purchase.price}
                        </span>
                      </TableCell>
                      <TableCell>
                      ...
                      <TableCell>
                        <div className="flex items-center gap-1.5">
                          <Download className="w-3.5 h-3.5 text-[#1a2240]" />
                      ...
                      <TableCell className="text-center">
                        <Button
                          size="sm"
                          className="bg-gradient-to-r from-[#24305e] via-[#4e5a7e] to-[#24305e] text-white border-none px-3 py-1.5 text-xs font-semibold rounded-lg shadow-md hover:shadow-lg transition-all duration-300 transform hover:scale-105"
                        >
              ...
              <Table>
                ...
                <TableBody>
                  {mockDownloads.map((download) => (
                    ...
                    >
                      <TableCell>
                        <h4 className="font-semibold text-[#1a2240] text-sm">{download.title}</h4>
                      </TableCell>
                      <TableCell>
                        <Badge
                          variant="outline"
                      ...
                      <TableCell className="text-center">
                        <Button
                          size="sm"
                          className="bg-gradient-to-r from-[#24305e] via-[#4e5a7e] to-[#24305e] hover:from-[#24305e] hover:to-[#2c3a6b] text-white border-none px-3 py-1.5 text-xs font-semibold rounded-lg shadow-md hover:shadow-lg transition-all duration-300 transform hover:scale-105"
                        >
                          <Download className="w-3.5 h-3.5 mr-1.5" />
                          Re-download
                        </Button>
